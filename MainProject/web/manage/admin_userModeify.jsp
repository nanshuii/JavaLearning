...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form action="admin_doUserUpdateHandle" method="post" id="myform" name="myform">
                ...
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="common-text required" id="mobile" name="mobile" size="50" value="${user.USER_MOBILE}" type="text">
                        </td>
                    </tr>
                    <tr>
