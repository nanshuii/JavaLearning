        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.html" class="fr">返回购物车</a></h3><!--------ul---------------->
                <c:forEach items="${cart_list}" var="cart">
                    <ul class="clearfix">
                        <li class="fl"><img src="/MainProject_war_exploded${cart.CART_PRO_FILENAME}" width="87" height="87"></li>
                        <li class="fl"><p>${cart.CART_PRO_NAME}</p>
                            <p>颜色分类：烟灰色玻璃瓶</p>
                            <p>数量：${cart.CART_PRO_QUALITY}</p></li>
                        <li class="fr">￥${cart.CART_PRO_TOTAL}</li>
                    </ul>
                </c:forEach>
                <ul class="clearfix">
