...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="/MainProject_war_exploded${product.PRODUCT_FILENAME}"/>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr"><h4>为你推荐</h4>
        <div class="seeList">
            <c:forEach items="${product_list_recommend}" var="product">
                <a href="productDetail?id=${product.PRODUCT_ID}">
                    <dl>
                        <dt><img src="/MainProject_war_exploded${product.PRODUCT_FILENAME}" width="161" height="243"></dt>
    ...
    <div class="bottom">
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                <div>
                    <c:forEach items="${product_list_last}" var="product">
                        <a href="productDetail?id=${product.PRODUCT_ID}">
                            <dl>
