    ...
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">[${login_user.USER_NAME}]</span><span class="fr"><a href="loginOut">[退出登录]</a></span></p></h3>
            <div><h4>我的交易</h4>
                <ul>
        ...
        <div class="you fl">
            <div class="tx clearfix">
                <div class="fl clearfix"><a href="#" class="fl"><img src="img/tx.png"/></a>
                    <p class="fl"><span>${login_user.USER_NAME}</span><a href="mygrxx.html">修改个人信息></a></p></div>
                <div class="fr">绑定邮箱：${login_user.USER_EMAIL}</div>
            </div>
            <div class="bott">
