...
<div class="address">
    <div class="wrapper clearfix"><a href="indexSelect">首页</a>
        <c:if test="${parentName != null}">
            <span>/</span>
            <a href="productSelect?id=${parentId}&name=${parentName}">${parentName}</a>
        </c:if>
        <span>/</span>
        <a href="productSelect?id=${id}&name=${name}&parentId=${parentId}&parentName=${parentName}" class="on">${name}</a>
    </div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">${name}</h3>
