                ...
                <div class="pro clearfix">
                    ...
                    <a class="fl" href="#">
                        <dl class="clearfix">
                            ...
                            <dd class="fl"><p>${cart.CART_PRO_NAME}</p><p>颜色分类:</p><p>白色瓷瓶+白色串枚</p></dd>
                        </dl>
                    </a>
                </div>
                <div class="price" id="price_num">￥${cart.CART_PRO_PRICE}</div>
                <div class="number"><p class="num clearfix">
                    <img class="fl sub" src="img/temp/sub.jpg">
                    <span class="fl" data-src="${cart.CART_ID}">${cart.CART_PRO_QUALITY}</span>
                    <img class="fl add" src="img/temp/add.jpg"></p></div>
                <div class="price sAll">￥${cart.CART_PRO_TOTAL}</div>
